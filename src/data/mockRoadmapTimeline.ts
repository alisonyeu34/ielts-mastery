...
// =============================================================================
// GIAI ĐOẠN 1: "CỨU NGỮ PHÁP NỀN TẢNG & XÂY GỐC" (14/9 - 14/10/2026) — Ngày 1-31
// =============================================================================

const PHASE1_MILESTONES: Record<number, Partial<RoadmapDayNode>> = {
  1: {
    title: "14/9 — Ngày 1: Khởi Động 4 Kỹ Năng • Dạy Kỹ Năng Trước - Luyện Tập Sau",
  ...
  2: {
    title: "15/9 — Ngày 2: True/False/Not Given & Hiện Tại Hoàn Thành",
  ...
  3: {
    title: "16/9 — Ngày 3: Điền Từ Khuyết & Câu Bị Động Khách Quan",
  ...
  4: {
    title: "17/9 — Ngày 4: Matching Headings & Cấu Trúc So Sánh",
  ...
  5: {
    title: "18/9 — Ngày 5: Multiple Choice & Mệnh Đề Quan Hệ",
  ...
  6: {
    title: "19/9 — Ngày 6: Matching Features & Câu Điều Kiện 1-2",
  ...
  7: {
    title: "20/9 — Ngày 7: Matching Info & Động Từ Khuyết Thiếu (Hedging)",
  ...
  8: {
    title: "21/9 — Ngày 8: Diagram Completion & Giới Từ Học Thuật",
  ...
  9: {
    title: "22/9 — Ngày 9: Full Passage 1 Thử Thách & 30 ĐT Bất Quy Tắc",
  ...
  10: {
    title: "23/9 — Ngày 10: Phân Tích C1 Cam 11 & Phòng Khám Lỗi Sâu",
  ...
  11: {
    title: "24/9 — Ngày 11: Củng Cố Cột Mốc Tuần 2 & Thử Thách 4 Kỹ Năng",
  ...
  31: {
    title: "14/10 — Ngày 31: ĐẠI KIỂM ĐỊNH TỐT NGHIỆP PHASE 1 (BAND 4.5 ➔ 5.5)",
...
const PHASE2_MILESTONES: Record<number, Partial<RoadmapDayNode>> = {
  ...
  12: {
    title: "27/9 (T7) — Environment: 20 Từ C1 + Đảo Ngữ Not only",
  ...
  13: {
    title: "28/9 (CN) — Environment: 20 Từ C1/C2 + Mệnh Đề Nhượng Bộ",
  ...
  14: {
    title: "25/9 (T5) — Environment: Collocations + Đảo Ngữ So/Such",
  ...
  15: {
    title: "26/9 (T6) — Environment: Đảo Ngữ Only + Cam 17 T2",
  ...
  16: {
    title: "29/9 (T2) — Tổng Kết Từ Vựng Environment + Cam 17 T2 P3",
  ...
  17: {
    title: "30/9 (T3) — Chuyển Tiếp Education + Câu Chẻ Cleft Sentences",
  ...
  18: {
    title: "1/10 (T4) — Education: 20 Từ C1 + Phân Từ Participles + Cam 17 T3",
  ...
  19: {
    title: "2/10 (T5) — Education Nâng Cao + Câu Chẻ Chuyên Sâu + Cam 18 T1",
  ...
  20: {
    title: "3/10 (T6) — Technology in Education + Đảo Ngữ Hardly/Scarcely + Cam 18 T1 P3",
  ...
  21: {
    title: "4/10 (T7) — Tổng Hợp Tuần 2: Education + Tech + Review Cam 18 T1",
  ...
  22: {
    title: "5/10 (CN) — Psychology & Learning + Phân Từ Hoàn Thành + Cam 18 T2",
  ...
  23: {
    title: "6/10 (T2) — Learning Methods + Mục Đích & Kết Quả + Cam 18 T3",
  ...
  24: {
    title: "7/10 (T3) — Ôn Tập Tổng Hợp Tuần 2 + Cam 18 Full Test",
  ...
  25: {
    title: "8/10 (T4) — Tổng Kết Tuần 2 + Làm Nóng Tuần 3",
  ...
  // --- Tuần 3 Giai đoạn 2 (8-14/10): Technology ---
  26: {
    title: "9/10 (T5) — Technology: 20 Từ C1 + Rút Gọn Mệnh Đề V-ing/V-ed + Cam 18 T4",
  ...
  27: {
    title: "10/10 (T6) — Technology & Internet + Rút Gọn Nâng Cao + Cam 18 T4 P3",
  ...
  28: {
    title: "11/10 (T7) — Technology Ethics + Phân Từ Hoàn Thành + Review Cam 18 T4",
  ...
  29: {
    title: "12/10 (CN) — Big Data & AI + Tổng Hợp Grammar + Cam 19 T1",
  ...
  30: {
    title: "13/10 (T2) — Full Test Cam 19 T1 + Tổng Ôn 3 Tuần",
  ...
  31: {
    title: "14/10 (T3) — Cybersecurity + Ôn Toàn Bộ Rút Gọn Mệnh Đề + Cam 19 T1 P3",
  ...
  32: {
    title: "15/10 (T4) — Tổng Kết Tuần 3 + Super Review + Cam 19 T2 Làm Nóng",
  ...
  33: {
    title: "14/10 (T4) — Health: 20 Từ C1 + So...That / Such...That + Cam 19 T2",
  ...
  34: {
    title: "15/10 (T5) — Mental Health + Mệnh Đề Nguyên Nhân + Cam 19 T2 P3",
  ...
  35: {
    title: "16/10 (T6) — Healthcare Systems + Cause-Effect Nâng Cao + Cam 19 T3",
  ...
  36: {
    title: "17/10 (T7) — Nutrition + Tổng Hợp Grammar Sức Khỏe + Cam 19 T3",
  ...
  37: {
    title: "18/10 (CN) — Full Test Cam 19 T2 + Full Test Writing Health",
  ...
  38: {
    title: "19/10 (T2) — Epidemics & Pandemics + Cam 19 T3 P3",
  ...
  39: {
    title: "20/10 (T3) — Tổng Kết Tuần 4 + Làm Nóng Tuần 5",
  ...
  40: {
    title: "21/10 (T4) — Economy: 25 Từ C1 + Câu Điều Kiện Hỗn Hợp (Mixed Cond P1) + Cam 19 T4",
  ...
  41: {
    title: "22/10 (T5) — Personal Finance + Mixed Cond với could/might + Cam 19 T4 P3",
  ...
  42: {
    title: "23/10 (T6) — Thương Mại + Luyện Mixed Cond + Review Cam 19 T4",
  ...
  43: {
    title: "24/10 (T7) — Full Test Tổng Hợp + Reading & Writing Marathon",
  ...
  44: {
    title: "25/10 (CN) — Full Test Cam 19 T4 Listening + Full Writing",
  ...
  45: {
    title: "26/10 (T2) — Ngày Khắc Phục Điểm Yếu",
  ...
  46: {
    title: "27/10 (T3) — MOCK TEST TOÀN DIỆN NHƯ THI THẬT",
...
const PHASE3_MILESTONES: Record<number, Partial<RoadmapDayNode>> = {
  47: {
    title: "28/10 (T4) — Urbanization: 25 Từ C1 + Cụm Danh Từ Phức Hợp + Cam 16 T1",
  ...
  48: {
    title: "29/10 (T5) — Law & Regulations + Error Hunting Grammar + Cam 16 T1 P3",
  ...
  49: {
    title: "30/10 (T6) — Infrastructure & Full Reading Cam 16 T2",
  ...
  50: {
    title: "31/10 (T7) — Full Test Cam 16 T1 Listening + Full Writing #4",
  ...
  51: {
    title: "1/11 (CN) — Khắc Phục Kỹ Năng Yếu + Full Test #5",
  ...
  52: {
    title: "2/11 (T2) — Reading Tốc Độ + Full Test #6 + Tổng Kết Tuần 1",
  ...
  53: {
    title: "3/11 (T3) — Globalization: 25 Từ C1 + V-ing/to V Chủ Ngữ + Cam 16 T3",
  ...
  54: {
    title: "4/11 (T4) — Social Inequality + Error Hunting Danh Từ + Cam 16 T3 P3",
  ...
  55: {
    title: "5/11 (T5) — Tổng Hợp Globalization + Full Listening Cam 16 T3 + Full Test #9",
  ...
  56: {
    title: "6/11 (T6) — Mock Full IELTS Test (Cam 15 T1) + Phân Tích Kết Quả",
  ...
  57: {
    title: "7/11 (T7) — Khắc Phục Sau Mock + Full Test #10",
  ...
  58: {
    title: "8/11 (CN) — Reading Tốc Độ 50p + Full Test #11",
  ...
  59: {
    title: "9/11 (T2) — Tổng Kết Tuần 2 + Full Test #12",
  ...
  60: {
    title: "10/11 (T3) — Crime & Justice: 29 Từ C1 + Đảo Ngữ Had/Should/Were + Cam 15 T3",
...
export function generate165DaysRoadmap(): RoadmapDayNode[] {
  ...
  for (let day = 1; day <= 165; day++) {
    ...
    // Phase 1: Day 1-31 (14/9 - 14/10) — Lấp 12 thì, xóa dịch word-by-word, 800 từ nền tảng
    // Phase 2: Day 32-77 (14/10 - 28/11) — 14 dạng bài & 2.500 từ chuyên ngành Passage 3
    // Phase 3: Day 78-165 (29/11 - 24/2) — Luyện đề Cambridge 17-19 & Về đích 7.5
