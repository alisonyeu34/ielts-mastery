...
interface ThreeStepBlueprintViewerProps {
  currentStep: 1 | 2 | 3 | 4;
...
export function ThreeStepBlueprintViewer({
  currentStep,
  onSelectStep,
  isGatePassed,
  isPassed,
  skill,
  className,
}: ThreeStepBlueprintViewerProps) {
  const passed = isGatePassed ?? isPassed ?? false;
  const steps = [
    {
      number: 1 as const,
      title: "Bước 1: Khái Niệm & Bản Chất",
      subtitle: "First-Principles Blueprint",
    ...
    {
      number: 3 as const,
      title: "Bước 3: Mổ Xẻ Bài Mẫu 8.5+",
