    ...
    >
      ...
      <div className="space-y-1.5">
        <span className="text-[10px] font-mono font-bold px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-emerald-500/20 uppercase tracking-wider">
          Hoàn Tất Phiên Chép Chính Tả
        </span>
        <h3 className="text-xl sm:text-2xl font-black text-foreground">
          Báo Cáo Độ Nhạy Tai & Âm Vị Học
        </h3>
        <p className="text-xs text-muted-foreground leading-relaxed">
          Đã giải mã các hiện tượng nối âm và lưu toàn bộ kết quả vào Dexie DB.
        </p>
      </div>
      ...
      <div className="space-y-2.5 pt-2">
        ...
        >
          ...
          <span>Xem {errorCount} Lỗi Âm Vị Trong Error Bank</span>
