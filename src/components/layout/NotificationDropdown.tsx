  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    {
      ...
      message: 'Hệ thống đã chuẩn bị sẵn sàng cho ngày học đầu tiên (16/9/2026). Mục tiêu: Bứt phá lên Band 7.5.',
      timeAgo: 'Hôm nay',
      unread: true,
      href: '/roadmap',
      icon: Sparkles,
    ...
    },
    {
      ...
      message: streakDays > 0
        ...
        : 'Bắt đầu học ngày mai (16/9/2026) để khởi động chuỗi ngày học đầu tiên nhé!',
      timeAgo: 'Hôm nay',
      unread: false,
      href: '/theory',
      icon: Flame,
