        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-3 max-w-2xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-red-500/30 bg-red-500/10 px-3 py-1 text-xs font-semibold text-red-700 dark:text-red-400">
              ...
              <span>Lộ trình 165 Ngày Tự Động (5.5 Tháng) • Khởi động: 12/9/2026 (Ngày 1/165)</span>
            </div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              Lộ trình học tập 3 giai đoạn vững vàng: <strong>14 Ngày Cứu Ngữ Pháp Nền Tảng (12/9 - 25/9)</strong> ➔ <strong>Chiến Thuật 4 Kỹ Năng & 2.500 Từ Chuyên Ngành Passage 3 (25/9 - 26/11)</strong> ➔ <strong>Luyện Đề Cambridge & Về Đích 7.5 (27/11 - 22/2)</strong>.
            </p>
            ...
            <div className="flex wrap items-center gap-4 pt-2">
              ...
              <div className="flex items-center gap-2 text-xs font-semibold text-foreground bg-secondary/80 px-3 py-1.5 rounded-xl border border-border">
                ...
                <span>Chuỗi học: 0 ngày (Bắt đầu 12/9)</span>
              </div>
              <div className="flex items-center gap-2 text-xs font-semibold text-foreground bg-secondary/80 px-3 py-1.5 rounded-xl border border-border">
          ...
          <div className="w-full lg:w-80 rounded-2xl border border-border bg-card/80 backdrop-blur-md p-5 space-y-4 shadow-sm">
            ...
            >
              Bắt đầu học Ngày 1 (12/9) <ArrowRight className="h-3.5 w-3.5" />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-bold text-foreground">
              4 Ca Học Ngày 1 — Quy Luật "Nạp Trước - Xả Sau" (Khởi động: 12/9/2026)
            </h3>
          </div>
